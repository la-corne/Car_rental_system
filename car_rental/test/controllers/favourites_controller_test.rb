...
#       post favourites_url, params: { favourite: { car_id: @favourite.car_id, user_id: @favourite.user_id } }
#     end
#
...
#     patch favourite_url(@favourite), params: { favourite: { car_id: @favourite.car_id, user_id: @favourite.user_id } }
